...
def test_dynamic_sampling():
    ...
    sampling_configs = [
        {"name": "greedy_temp_0", "temperature": 0.0, "top_p": 1.0, "top_k": -1},
        {"name": "greedy_topk_1", "temperature": 1.0, "top_p": 1.0, "top_k": 1},
        {"name": "standard", "temperature": 0.7, "top_p": 0.9, "top_k": -1},
        {"name": "topk_50", "temperature": 1.0, "top_p": 1.0, "top_k": 50},
        {"name": "high_temp", "temperature": 1.5, "top_p": 0.95, "top_k": -1},
    ]
    ...
    logger.info("Test 3 PASSED: Greedy consistency validated (temp=0 == top_k=1)\n")
    ...
    assert unique_texts >= 2, f"Expected diversity, got {unique_texts} unique out of 4"
    logger.info(f"Test 4 PASSED: Diversity validated ({unique_texts}/4 unique)\n")
