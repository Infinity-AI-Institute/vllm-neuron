...
def test_inference_tinyllama_prefill_disabled():
    ...
    expected_outputs = {
        ...
        "The future of AI is": " bright, and it's not just for big companies. Small businesses can",
        "The highest mountain in the world is": " Mount Everest, which is located in Nepal. The mountain is 2",
    }
