...
class NeuronxDistributedModelRunner(LoRAModelRunnerMixin, KVConnectorModelRunnerMixin):
    ...
    def execute_model(
        ...
        # This is a blocking call. The reasons are:
        # 1. we want to prevent blocks from being overwritten by
        # subsequent requests within a prefill node.
        # 2. we want to make sure kv tensors are readily staged
        # on host mem for transfer, when decode node reaches out.
