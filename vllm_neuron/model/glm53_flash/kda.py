...
KDA_KERNEL_SLUG = "kda_state.decode.kda_gate.rank1_delta.bf16_state.v1"
...
class Glm53KdaAttention(nn.Module):
    ...
    def forward(
        ...
        if length == 1:
            outputs = golden.kda_state_decode_forward_v2(inputs, impl=impl)
...
__all__ = ["KDA_KERNEL_SLUG", "Glm53KdaAttention"]
