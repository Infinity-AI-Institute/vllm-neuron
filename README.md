...
- Latest AWS Neuron SDK ([Neuron SDK 2.31.0](https://awsdocs-neuron.readthedocs-hosted.com/en/latest/release-notes/2.31.0.html))
...
```bash
git clone --branch "0.5.2" https://github.com/vllm-project/vllm-neuron.git
cd vllm-neuron
