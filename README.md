...
- Latest AWS Neuron SDK ([Neuron SDK 2.30.0](https://awsdocs-neuron.readthedocs-hosted.com/en/latest/release-notes/2.30.0.html))
...
```bash
git clone --branch "0.5.1" https://github.com/vllm-project/vllm-neuron.git
cd vllm-neuron
